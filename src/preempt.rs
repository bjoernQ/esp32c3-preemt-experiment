use crate::FullTrapFrame;

#[derive(Debug, Default, Clone, Copy)]
pub struct Context {
    trap_frame: FullTrapFrame,
    pc: usize,
    _running: bool,
}
...
pub static mut CTX_TASKS: [Context; MAX_TASK] = [Context {
    trap_frame: FullTrapFrame {
        ra: 0,
        t0: 0,
        t1: 0,
...
pub fn task_to_trap_frame(id: usize, trap_frame: &mut FullTrapFrame) -> usize {
    unsafe {
...
pub fn trap_frame_to_task(id: usize, pc: usize, trap_frame: &FullTrapFrame) {
    unsafe {
...
pub fn task_switch(trap_frame: &mut FullTrapFrame) {
    unsafe {
